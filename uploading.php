...
<script src="js/uploadingjs.js">
    ...
    <Header>
        <div class="headline">
            ...
            <div class="icons">
                <?php if (isset($_SESSION['logged_user_id'])) {echo "<a href=\"profile.php\" class=\"headlineicon xxxlarge material-icons\">person</a>";}else{echo "<a href=\"login.php\" class=\"headlineicon xxxlarge material-icons\">person</a>";}?>
    ...
    <body style="background-color: #e6e6e6">
        ...
        <form action="backend/upload.php" method="post" enctype="multipart/form-data">
                        ...
                        <label for="button-upload" class="custom-file-upload">
                        Upload
                        </label>
                        <br>
